...
# It will also calculate how much you make and determine if you have excess
...
# (continued)then add up all the variables and print it.
...
def expenses(mortgage_or_rent, house_insurance, electric, utilities,
             ...
             clothing, savings):
    expense_total = (mortgage_or_rent + house_insurance + electric + utilities
...
def main():
    ...
    house_insurance = float(input("Enter the cost of your house insurance for "
                                  "the month: $"))
    electric = float(
        input("Enter the cost of your electric bill for the month:"
              " $"))
    ...
    savings = float(input("Enter the amount you set aside for savings for the "
                          "month: $"))
    expense_total = expenses(mortgage_or_rent, house_insurance, electric,
                             utilities, car_payment, car_insurance, gas,
                             phone, food, entertainment, clothing, savings)
    print("Total expenses for the month: $" + format(expense_total, '.2f'))
    # formats total for 2 decimal places
...
while salaried_or_wage not in ("salaried", "wage"):
    # the 2 previous lines of code i got the idea from Martin O'Shea,
    # Sept 20, 2017, https://www.quora.com/I%E2%80%99m-new-to-Python-how-can
    # -I-write-a-yes- no-question It creates a loop that keeps asking the
    # question if you don't give the right answer
    ...
    if salaried_or_wage == "salaried":
        ...
        net_monthly_salary: float = (
                gross_monthly_salary - taxes - social_security
                - medicare)
        net_weekly_salary = (net_monthly_salary // 4)
        print(
            "Your net monthly income is $" + format(net_monthly_salary, '.2f'))
...
if salaried_or_wage == "salaried":  # if you picked salaried earlier, your
    # leftover money will be calculated here.
